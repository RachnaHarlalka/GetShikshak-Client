          ...
          >
            ...
            <div className="flex justify-between">
              <div className="w-1/2 flex items-center justify-start">
                ...
                <input type="text" disabled value={Formik.values.phone} className="mx-4 border-2 p-2 rounded-md my-2"/>
              </div>
              <div className="w-1/2 flex items-center justify-end">
                <label htmlFor="address">Address</label>
                <input type="text" disabled value={Formik.values.address} className="mx-4 border-2 p-2 rounded-md my-2"/>
              </div>
            </div>
