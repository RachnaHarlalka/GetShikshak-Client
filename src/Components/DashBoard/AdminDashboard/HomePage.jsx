  ...
  function notificationDetailsPage() {
    return (
      <div
        ...
        className="admin-sub-container-div"
      ...
      >
        ...
        <div style={{ overflowY: "auto" }}>
          <div className="row-div margin-buttom-div">
            <div
              className="display-type-flex width-100"
              id="request-details-div"
            >
                ...
                <div id="profile-pic-section">
                  <div id="profile-pic" style={{ width: "100%" }}>
                    <img
                      id="profile-image"
                      alt="image"
                      src={`http://localhost:3000/assets/${currentNotification?.profilePic}`}
                    />
                  </div>
                </div>
              </div>
              <div className="admin-sub-container-div" style={{ width: "78%" }}>
                <div className="div-heading">PERSONAL DETAILS</div>
          ...
          <div className="row-div margin-buttom-div justify-center">
            ...
            <div className="admin-sub-container-div w-1/2">
              <div className="div-heading">LANGUAGES</div>
            ...
            <div className="admin-sub-container-div w-1/2">
              <div className="div-heading">RATE</div>
              <div className="content-div" id="rate-display-div">
                <span style={{ fontSize: "large" }}>
                  ₹
                  <span style={{ fontWeight: "bold" }}>
                    {currentNotification?.tutorForm?.rate}
                  </span>
                  /hr
                </span>
              </div>
          ...
          <div className="admin-sub-container-div">
            <div className="" id="document-div">
              <div className="div-heading">DOCUMENTS</div>
              <div className="flex">
                <div className="single-document" id="id-proof-div">
                  ...
                  <div className="">
                    <div className="tutor-request-document-show-div">
                      <img
                        className="w-64 h-[20rem] object-cover"
                        src={`http://localhost:3000/assets/${currentNotification?.tutorForm?.identity}`}
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="single-document" id="qualification-proof-div">
                  ...
                  <div className="">
                    <div className="tutor-request-document-show-div">
                      <img
                        className="w-64 h-[20rem] object-cover"
                        src={`http://localhost:3000/assets/${currentNotification?.tutorForm?.lastEducationalCertificate}`}
                        alt=""
                      />
                    </div>
                  </div>
