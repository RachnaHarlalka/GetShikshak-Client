  ...
  function notificationDetailsPage() {
    ...
    return (
      <div
        ...
        className="tutor-sub-container-div"
              ...
              <div id="content-heading" className="request-content-sub-div">
                ...
                <span style={{ textTransform: "none" }}>
                  ...
                  <span style={{ fontWeight: "normal" }}>
                    {currentNotification?.studentId?.email}
                  </span>
                </span>
              </div>
        ...
        <div className="row-div mb-12" id="first-row-home-page">
            ...
            <span id="user-name">
              ...
              {userData?.tutorForm?.isProfileVerified === "accepted" ? (
                <Tooltip title="Account Verified" placement="right" arrow>
                  <span id="verified-tag">
                    <VscVerifiedFilled color="green" />
                  </span>
                </Tooltip>
              ) : userData?.tutorForm?.isProfileVerified === "reverted" ? (
                <Tooltip title="Account reverted back" placement="right" arrow>
                  <span id="verified-tag">
                    <GoUnverified color="rgb(165, 58, 58)" />
                  </span>
                </Tooltip>
              ) : (
          ...
          {userData?.tutorForm?.isProfileVerified === "pending" && (
            <div class="tutor-sub-container-div text-red-500 font-semibold flex justify-center flex-col">
             <div>⚠ Your Ads will be displayed to others only if your account is
              verified by the Admin.</div>
              <div>⚠It will take 1-2 working days.</div>
            </div>
          )}
           {userData?.tutorForm?.isProfileVerified === "reverted" && (
            <div class="tutor-sub-container-div text-red-500 font-semibold flex justify-center flex-col">
             <div>⚠ Admin has reverted your profile.</div>
             <div>⚠ Please revisit your documents. </div>
              
            </div>
          )}
           {userData?.tutorForm?.isProfileVerified === "rejected" && (
            <div class="tutor-sub-container-div text-red-500 font-semibold flex justify-center flex-col">
             <div>⚠ Admin has rejected your profile.</div>
             <div>⚠ You cannot enroll as teacher. </div>
